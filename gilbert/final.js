...
var vibration_sensor = new mraa.Gpio(5);
vibration_sensor.dir(mraa.DIR_IN);
...
function sense(){
  var vibration = vibration_sensor.read();
  ...
  //Cases
  if (distance < .3){
    vibration ? buzzer.write(1) : buzzer.write(0);
    redlight.write(1);
    greenlight.write(0);
  }
  else if (distance < 1.5) {
    buzzer.write(0);
    vibration ? redlight.write(1) : redlight.write(0);
    greenlight.write(0);
  }
  else {
    buzzer.write(0);
